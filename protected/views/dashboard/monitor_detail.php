							...
							<form>
								...
								<div class="row">
									<div class="small-6 columns">
										...
										echo CHtml::ajaxSubmitButton('Submit', $this->createUrl('monitordetailsummary', array('monitorId' => $monitor->id, 'serverId' => $server->id)), array(
...
<script>
	...
	$(function () {
		...
		setInterval(function () {
			$.fn.yiiGridView.update("monitor-detail-grid");
