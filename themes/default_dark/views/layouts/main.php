                            ...
                            $this->widget('zii.widgets.CMenu', array(
                                ...
                                'items' => array(
                                    ...
                                    array('label' => '<i class="fa fa-laptop fa-fw"></i>' . ' Application ' . '<b class="caret"></b>', 'url' => '',
                                        'items' => array(
                                           array('label' => '<i class="fa fa-cogs fa-fw"></i>' . ' Setup', 'url' => '',
                                                'items' => array(
                                                    array('label' => '<i class="fa fa-desktop fa-fw"></i>' . ' Aplikasi', 'url' => array('/setupaplikasi/index')),
                                                    array('label' => '<i class="fa fa-code fa-fw"></i>' . ' Monitor', 'url' => array('/monitor/index')),
                                                    array('label' => '<i class="fa fa-database fa-fw"></i>' . ' Server', 'url' => array('/server/index')),
                                                    array('label' => '<i class="fa fa-code fa-fw"></i>' . ' Notifikasi', 'url' => array('/notifikasi/index')),
                                                    array('label' => '<i class="fa fa-code fa-fw"></i>' . ' Notifikasi Aksi', 'url' => array('/notifikasiaksi/index')),
//                                                    array('label' => '<i class="fa fa-file fa-fw"></i>' . ' Return Type', 'url' => array('/returntype/index')),
//                                                    array('label' => '<i class="fa fa-bar-chart-o fa-fw"></i>' . ' View Type', 'url' => array('/viewtype/index')),
//                                                    array('label' => '<i class="fa fa-exchange fa-fw"></i>' . ' Config', 'url' => array('/config/index')),
                                                ),
